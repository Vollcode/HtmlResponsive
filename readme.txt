...
cambios leves:
en bootstrap.sh he añadido 2 lineas para actualizar la versión de node dentro de vagrant por problemas
                de compatibilidad con nodemailer, hará falta un vagrant provision
